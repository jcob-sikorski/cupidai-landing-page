      ...
      <div className="flex w-[480px] max-w-[480px]">
        <Card width="full">
          ...
          {/* <div className="flex gap-2 items-center">
            <Checkbox active={agreement} onClick={handleAgreement} />
            <div className="flex gap-2 text-textd">
              <p>Agree to our</p>

              <TertiaryButton>Terms of use</TertiaryButton>

              <p>and</p>

              <TertiaryButton>Privacy Policy</TertiaryButton>
            </div>
          </div> */}
          ...
          {/* <ChildCard>
            <div className="flex items-center justify-between w-full">
              <div className="flex gap-2 items-center">
                <Checkbox active={reCaptcha} onClick={handleReCaptcha} />
                <p>I’m not a robot</p>
              </div>

              <Image width={48} height={48} alt="" src="/recaptcha.svg" />
            </div>
          </ChildCard> */}
          ...
          <div className="flex flex-col w-full gap-4">
            ...
            >
              ...
              <PrimaryBoxButton>Sign up</PrimaryBoxButton>
            </div>
